...
<head>
<title>Processor Test Centre Requests</title>
...
$mailContent = "-------- STUDENT INFORMATION --------\n\n" 
			...
			."-------- PROCTORING OPTION --------\n\n"
			."Proctoring Option: ".$proctoring_option."\n\n"
			."-------- TEST CENTRE CAMPUS INFORMATION --------\n\n"
...
$subject = "Test Centre Proctor Request Form: ".$space.$coursecode.$space.$course_section;
$confSubject = "Test Centre Request for ".$space.$coursecode.$space.$course_section.$space." Received";
...
elseif($coursecode == 'BRTV 330'){mail($toJey, $subject, $mailContent, "From: $email"); mail($email, $confSubject, $ack, "From: $toJey");}	
elseif($coursecode == 'BRTV 430'){mail($toJey, $subject, $mailContent, "From: $email"); mail($email, $confSubject, $ack, "From: $toJey");}	
...
elseif($coursecode == 'QENG 151'){mail($toJey, $subject, $mailContent, "From: $email"); mail($email, $confSubject, $ack, "From: $toJey");}	
...
echo '<p class="format">Thank you, <b>'.$first_name.' '.$last_name. '</b>, for submitting the Test Centre Request Form for Online Students. <br /> <br />You will receive an email confirmation from one of the OLC Staff members once we receive the approval for the request. If you are taking an additional online
course, please <a href=\'javascript:history.go(-1)\'>go back</a> and fill the <a href=\'javascript:history.go(-1)\'>Test Centre Request</a> form again.<br /></p>
