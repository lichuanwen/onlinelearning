...
?>                  
   ...
   <br>
   <img name="virtualproctor_banner" src="images/virtualproctor_banner.jpg" width="940" height="70" border="0" alt="Virtual Proctor Request Form for Online Students"><br>
       
 <iframe src="virtual-proctor.php" width="955" height="1000" scrolling="no" frameborder="0"></iframe>
