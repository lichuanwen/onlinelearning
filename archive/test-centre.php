...
<body>
<form id="proctor" name="proctor" method="post" action="process_testcentre.php" onsubmit="return validate();">
  <fieldset>
...
<li>
    <label for="comments">Describe in detail why you are submitting the Test Centre request form. Be sure to provide any further detail that may help us process your proctor request faster </label>
