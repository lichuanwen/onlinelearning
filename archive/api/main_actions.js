...
var divpopup = function ($CID){
        ...
        var $result = data;
            if ($result){
               ...
               // bigWindow += "<p> <span class='big-window-heading'>Availability</span>: "+R.availability + '<a href="http://calendardb.humber.ca/LIS/WebCalendar/CE/CourseOffering.do?name=' + R.coursename + '_' + R.coursenumber+ '" target="_blank">Continuing Education Calendar</a></p>";
                bigWindow += "<p> <strong>Availability</strong>: "+ R.availability + "<a href=\"http://calendardb.humber.ca/LIS/WebCalendar/CE/CourseOffering.do?name=" +
                    R.coursename + "_" + R.coursenumber + "\" target='_blank'>See course availability details</a></p>"; 
