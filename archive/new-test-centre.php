...
<body>
<form id="proctor" name="proctor" method="post" action="new_process_testcentre.php" onsubmit="return validate();">
  <fieldset>
  ...
  <ol>
    ...
    <input name="studentNum" type="text" id="studentNum" size="40" title="Enter a valid 9 digit Humber student number with dashes. For example: xxx-xxx-xxx" /></li>
    <li>
...
<li>
<input name="proctoring_option" id="proctoring_option_01" type="radio" class="switch-proctoring_option" value="Humber Test Centre" />Humber Test Centre<br />&nbsp;<br />
