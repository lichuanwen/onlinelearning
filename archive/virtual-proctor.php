...
<body>
<form id="proctor" name="proctor" method="post" action="process_virtual.php" onsubmit="return validate();">


  <!-- The following is the fieldset for choosing virtual or test centre. -->
    <fieldset class="alt">
<legend><span style="width: auto;">Virtual Proctoring Eligibility and Fee</span></legend>
<ol>

<li>
<div style="font-family: 'Myriad Web Pro', Verdana, Geneva, sans-serif; font-size: 14px; font-style: italic; width: 700px; margin-left: 25px;">With Virtual Proctoring, you can take the online exam from the comfort of your home provided that you live more than 100 km from Humber College's North campus, have a high speed Internet connection, and a good quality web cam.  For specific virtual proctoring requirements, go to <a href="http://onlineproctornow.com/techreq.php" target="_blank">http://onlineproctornow.com/techreq.php </a></div>
</li>

<li> 
    <div style="font-family: 'Myriad Web Pro', Verdana, Geneva, sans-serif; font-size: 14px; font-style: italic; width: 700px; margin-left: 25px;">
        The virtual proctoring fee for exams that are up to two hours in length is $60.00.<br />
        The virtual proctoring fee for exams that exceed two hours in length is $80.00.  <br />
		Please confirm with your instructor the length of your final exam.
    </div>
</li>

<li> 
<div style="font-family: 'Myriad Web Pro', Verdana, Geneva, sans-serif; font-size: 14px; font-style: italic; width: 700px; margin-left: 25px;">To see how Virtual Proctoring works, watch the video at <a href="http://www.humber.ca/onlinelearning/virtualproctoring.html" target="_blank">http://www.humber.ca/onlinelearning/virtualproctoring.html</a></div>
</li>
...
<input name="campus" type="hidden" value="Virtual Proctoring" />

</li>


<li>
    <label for="comments">Describe in detail why you are submitting the Virtual Proctor request form. Be sure to provide any further detail that may help us process your proctor request faster</label>
