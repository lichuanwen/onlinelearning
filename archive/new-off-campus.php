...
<script src="wforms.js" type="text/javascript"></script>


<style type="text/css">

	.onstate-proctoring_option { display: block; } 
	.offstate-proctoring_option { display: none; }
...
<body>
<form id="proctor" name="proctor" method="post" action="new_process_proctors.php" onsubmit="return validate();">
  <fieldset>
...
<select name="courseSection" title="Select your online course's section" style="width: 80px; font-family: Calibri; font-size: 13px; ">
    ...
    <fieldset class="alt required">
<legend><span>Choose a Proctoring Option</span></legend>
<ol>

<li>
<input name="proctoring_option" id="proctoring_option_01" type="radio" class="switch-proctoring_option" value="Off Campus Proctor" />Off Campus Proctoring Site<br />&nbsp;<br />
<input name="proctoring_option" id="proctoring_option_02" type="radio" value="Virtual Proctoring" />Virtual Proctoring<br />
<div style="font-family: 'Myriad Web Pro', Verdana, Geneva, sans-serif; font-size: 12px; font-style: italic; width: 450px; margin-left: 25px;">With Virtual Proctoring, you can take the online exam from the comfort of your home provided that you have a high speed Internet connection and a good quality web cam.  For specific virtual proctoring requirements, go to <a href="http://onlineproctornow.com/techreq.php" target="_blank">http://onlineproctornow.com/techreq.php </a></div>
</li>
  ...
  <fieldset class="offstate-proctoring_option"><legend><span>Proctor Information</span></legend>
<ol>
...
<input name="proctorPhone" type="text" size="40" title="Enter your proctor's phone number with area code" />
  ...
  <fieldset class="offstate-proctoring_option">
  ...
  <ol>
    ...
    <fieldset class="alt">
  <legend><span>Additional Notes/Comments</span></legend>
  <ol>
    <li>
